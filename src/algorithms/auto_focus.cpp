...
void auto_alg::impl::auto_focus::setup_run(
    int focus_val,
    const auto_alg::auto_focus_params::run_cmd_param_struct& params,
    img::rect roi)
{
...
bool auto_alg::impl::supports_auto_focus(const img::img_type& img) noexcept
{
    ...
    if (img.fourcc_type() != img::fourcc::MONO8 && img.fourcc_type() != img::fourcc::MONO16
        && img::is_by16_fcc(img.fourcc_type()) && img::is_by8_fcc(img.fourcc_type())
        && img.fourcc_type() != img::fourcc::BGRA32 && img.fourcc_type() != img::fourcc::BGR24)
    {
        return false;
    }
...
bool auto_alg::impl::auto_focus::is_auto_alg_run_needed(
    const auto_alg::auto_focus_params& params) noexcept
{
...
bool auto_alg::impl::auto_focus::auto_alg_run(uint64_t time_point,
...
bool auto_alg::impl::auto_focus::analyze_frame(uint64_t now,
                                               const img::img_descriptor& img,
                                               int& new_focus_val)
{
...
void auto_alg::impl::auto_focus::find_region(const img::img_descriptor& image,
                                             img::rect roi,
                                             RegionInfo& region)
{
