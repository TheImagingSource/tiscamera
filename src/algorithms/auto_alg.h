...
namespace auto_alg::impl
{
    ...
    void                    apply_software_params_to_sampling_data( image_sampling_data& sampling_data, const auto_alg::color_matrix_params& clr_mtx );
    void                    apply_software_params_to_sampling_data( image_sampling_data& sampling_data, const auto_alg::wb_channel_factors& wb_params );
}
