...
void auto_alg::impl::apply_software_params_to_sampling_data( image_sampling_data& sampling_data, const auto_alg::color_matrix_params& clr_mtx )
{
    if( !clr_mtx.enabled ) {
        return;
    }
...
void auto_alg::impl::apply_software_params_to_sampling_data( image_sampling_data& sampling_data, const auto_alg::wb_channel_factors& wb_params )
{
