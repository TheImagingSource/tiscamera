...
tcam_image_buffer tcam::algorithms::parallel::split_image_buffer(
    const tcam_image_buffer& img_to_split,
    int idx_to_generate,
                                                                ...
                                                                int max_conc)
{
    ...
    thread_pool_ref_->queue_items_and_wait(img_ready_latch_, work_item_space_, split_count);
}
