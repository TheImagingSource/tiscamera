...
)
{
    ...
    apply_software_params_to_sampling_data( state.image_sampling_points, params.clr );
    ...
    if( params.wb.is_software_whitebalance ) {
        ...
        apply_software_params_to_sampling_data( state.image_sampling_points, rval.wb_res.channels );
    }
