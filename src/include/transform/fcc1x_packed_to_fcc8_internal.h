...
namespace fcc1x_packed_internal
{
    ...
    inline uint8_t  calc_fcc12_packed_mipi_to_fcc8( const void* src, int offset ) noexcept;
    ...
    inline uint8_t  calc_fcc10_packed_mipi_to_fcc8( const void* src_line, int offset ) noexcept;
