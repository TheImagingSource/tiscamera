...
namespace img
{
	enum class fourcc : uint32_t
	{
		...
		MONO16_L12 = FOURCC_MONO16_L12,
		MONOFloat = FOURCC_MONOFloat,

		MONO10_PACKED = FOURCC_MONO10_PACKED,
		...
		BGGR16_L12 = FOURCC_BGGR16_L12,
		GBRG16_L12 = FOURCC_GBRG16_L12,
		GRBG16_L12 = FOURCC_GRBG16_L12,
		RGGB16_L12 = FOURCC_RGGB16_L12,
		...
		PWL_MONO12_MIPI = FOURCC_PWL_MONO12_MIPI,
