...
constexpr int calc_planar_fmt_count_of_planes(
    uint32_t
        fcc) noexcept; // == 1 for all packed formats, otherwise the count of planes in this format

constexpr int get_bits_per_pixel(uint32_t fcc) noexcept
{
    return get_bits_per_pixel(static_cast<fourcc>(fcc));
}
constexpr int get_bits_per_pixel(fourcc fcc) noexcept
{
    switch (fcc)
    {
        case fourcc::FCC_NULL:
            return 0;
        case fourcc::BGR24:
            return 24;
        case fourcc::BGRA32:
        ...
        case fourcc::IYU1:
            return 12;
        case fourcc::Y411:
            return 12; // the same format as IYU1
        case fourcc::IYU2:
            return 24;
        case fourcc::NV12:
            return 12;
        ...
        case fourcc::MONO16:
            return 16;
        case fourcc::MONO16_L12:
            return 16;
        case fourcc::MONOFloat:
            return 32;

        case fourcc::MONO10_PACKED:
            return 10;
        case fourcc::MONO10_MIPI_PACKED:
            return 10;

        case fourcc::MONO12_PACKED:
            return 12;
        case fourcc::MONO12_MIPI_PACKED:
            return 12;
        case fourcc::MONO12_SPACKED:
            return 12;
        ...
        case fourcc::BGGRFloat:
            return 32;
        case fourcc::GBRGFloat:
            return 32;
        case fourcc::GRBGFloat:
            return 32;
        case fourcc::RGGBFloat:
            return 32;

        case fourcc::BGGR16_L12:
            return 16;
        case fourcc::GBRG16_L12:
            return 16;
        case fourcc::GRBG16_L12:
            return 16;
        case fourcc::RGGB16_L12:
            return 16;

        case fourcc::GRBG10_MIPI_PACKED:
            return 10;
        case fourcc::RGGB10_MIPI_PACKED:
            return 10;
        case fourcc::GBRG10_MIPI_PACKED:
            return 10;
        case fourcc::BGGR10_MIPI_PACKED:
            return 10;

        case fourcc::GRBG10_SPACKED:
            return 10;
        case fourcc::RGGB10_SPACKED:
            return 10;
        case fourcc::GBRG10_SPACKED:
            return 10;
        case fourcc::BGGR10_SPACKED:
            return 10;

        case fourcc::GRBG12_PACKED:
            return 12;
        case fourcc::RGGB12_PACKED:
            return 12;
        case fourcc::GBRG12_PACKED:
            return 12;
        case fourcc::BGGR12_PACKED:
            return 12;

        case fourcc::GRBG12_MIPI_PACKED:
            return 12;
        case fourcc::RGGB12_MIPI_PACKED:
            return 12;
        case fourcc::GBRG12_MIPI_PACKED:
            return 12;
        case fourcc::BGGR12_MIPI_PACKED:
            return 12;

        case fourcc::GRBG12_SPACKED:
            return 12;
        case fourcc::RGGB12_SPACKED:
            return 12;
        case fourcc::GBRG12_SPACKED:
            return 12;
        case fourcc::BGGR12_SPACKED:
            return 12;

        case fourcc::YUV8PLANAR:
            return 24;
        case fourcc::YUV16PLANAR:
            return 48;
        case fourcc::YUVF32PLANAR:
            return 96;

        case fourcc::MJPG:
            return 24;

        case fourcc::POLARIZATION_MONO8_90_45_135_0:
            return 8;
        case fourcc::POLARIZATION_MONO16_90_45_135_0:
            return 16;
        case fourcc::POLARIZATION_MONO12_PACKED_90_45_135_0:
            return 12;
        case fourcc::POLARIZATION_MONO12_SPACKED_90_45_135_0:
            return 12;

        case fourcc::POLARIZATION_BG8_90_45_135_0:
            return 8;
        case fourcc::POLARIZATION_BG16_90_45_135_0:
            return 16;
        case fourcc::POLARIZATION_BG12_PACKED_90_45_135_0:
            return 12;
        case fourcc::POLARIZATION_BG12_SPACKED_90_45_135_0:
            return 12;

        case fourcc::POLARIZATION_ADI_MONO8:
            return 32;
        case fourcc::POLARIZATION_ADI_MONO16:
            return 64;
        case fourcc::POLARIZATION_ADI_PLANAR_MONO8:
            return 32;
        case fourcc::POLARIZATION_ADI_PLANAR_MONO16:
            return 64;
        case fourcc::POLARIZATION_ADI_RGB8:
            return 64;
        case fourcc::POLARIZATION_ADI_RGB16:
            return 128;

        case fourcc::POLARIZATION_PACKED8:
            return 32;
        case fourcc::POLARIZATION_PACKED16:
            return 64;
        case fourcc::POLARIZATION_PACKED8_BAYER_BG:
            return 32;
        case fourcc::POLARIZATION_PACKED16_BAYER_BG:
            return 64;
        ...
        case fourcc::PWL_MONO12_MIPI:
            return 12;
        case fourcc::PWL_RG12_MIPI:
            return 12;
    }
...
constexpr bool is_yuv_format(uint32_t fcc) noexcept
{
    switch ((img::fourcc)fcc)
    {
        case img::fourcc::YUY2:
            return true;
        case img::fourcc::UYVY:
            return true;
        case img::fourcc::YUV8PLANAR:
            return true;
        case img::fourcc::IYU1:
            return true;
        case img::fourcc::IYU2:
            return true;
        case img::fourcc::YUV16PLANAR:
            return true;
        case img::fourcc::YUVF32PLANAR:
            return true;
        default:
            return false;
    }
...
constexpr bool is_by16L12_fcc(uint32_t fcc) noexcept
{
    switch ((img::fourcc)fcc)
    {
        case img::fourcc::BGGR16_L12:
        case img::fourcc::GBRG16_L12:
        case img::fourcc::RGGB16_L12:
        case img::fourcc::GRBG16_L12:
            return true;
        default:
            return false;
    };
...
constexpr bool is_y10_packed_fcc(uint32_t fcc) noexcept
{
    return fcc == FOURCC_MONO10_PACKED || fcc == FOURCC_MONO10_MIPI_PACKED;
}
constexpr bool is_y12_packed_fcc(uint32_t fcc) noexcept
{
    switch ((img::fourcc)fcc)
...
constexpr bool is_y10or12or16L12_fcc(uint32_t fcc) noexcept
{
    return img::is_y10_packed_fcc(fcc) || img::is_y12_packed_fcc(fcc) || fcc == FOURCC_MONO16_L12;
}
...
constexpr bool is_polarization_cam_format(uint32_t fcc) noexcept
{
    switch ((img::fourcc)fcc)
    {
        case img::fourcc::POLARIZATION_MONO8_90_45_135_0:
            return true;
        case img::fourcc::POLARIZATION_MONO16_90_45_135_0:
            return true;
        case img::fourcc::POLARIZATION_MONO12_PACKED_90_45_135_0:
            return true;
        case img::fourcc::POLARIZATION_MONO12_SPACKED_90_45_135_0:
            return true;

        case img::fourcc::POLARIZATION_BG8_90_45_135_0:
            return true;
        case img::fourcc::POLARIZATION_BG16_90_45_135_0:
            return true;
        case img::fourcc::POLARIZATION_BG12_PACKED_90_45_135_0:
            return true;
        case img::fourcc::POLARIZATION_BG12_SPACKED_90_45_135_0:
            return true;
        default:
            return false;
    }
...
constexpr bool is_bayer_fcc(uint32_t fcc) noexcept
{
    return is_by8_fcc(fcc) || is_by16_fcc(fcc) || is_by10_packed_fcc(fcc) || is_by12_packed_fcc(fcc)
           || is_by16L12_fcc(fcc) || is_byfloat_fcc(fcc);
}

constexpr bool is_bottom_up_fcc(uint32_t fcc) noexcept
{
    return fcc == FOURCC_BGR24 || fcc == FOURCC_BGRA32 || fcc == FOURCC_BGRA64;
}
constexpr bool is_known_fcc(uint32_t fcc) noexcept
{
...
constexpr bool is_multi_plane_format(uint32_t fcc) noexcept
{
    return calc_planar_fmt_count_of_planes(fcc) > 1;
}
...
constexpr planar_info get_fcc_info(fourcc fcc) noexcept
{
    switch (fcc)
    {
        case fourcc::YUV8PLANAR:
            return planar_info {
                3, { { img::fourcc::MONO8, 8 }, { img::fourcc::RAW8, 8 }, { img::fourcc::RAW8, 8 } }
            };
        case fourcc::YUV16PLANAR:
            return planar_info { 3,
                                 { { img::fourcc::MONO16, 16 },
                                   { img::fourcc::RAW16, 16 },
                                   { img::fourcc::RAW16, 16 } } };
        case fourcc::YUVF32PLANAR:
            return planar_info { 3,
                                 { { img::fourcc::MONOFloat, 32 },
                                   { img::fourcc::RAW32, 32 },
                                   { img::fourcc::RAW32, 32 } } };

        case fourcc::NV12:
            return planar_info {
                2, { { img::fourcc::MONO8, 8 }, { img::fourcc::RAW16, 16, 0.5f, 0.5f } }
            };
        case fourcc::YV12:
            return planar_info { 3,
                                 { { img::fourcc::MONO8, 8 },
                                   { img::fourcc::RAW8, 8, 0.5f, 0.5f },
                                   { img::fourcc::RAW8, 8, 0.5f, 0.5f } } };

        case fourcc::POLARIZATION_ADI_PLANAR_MONO8:
            return planar_info { 4,
                                 { { img::fourcc::RAW8, 8 },
                                   { img::fourcc::RAW8, 8 },
                                   { img::fourcc::RAW8, 8 },
                                   { img::fourcc::RAW8, 8 } } };
...
{
    const auto info = get_fcc_info(fcc).planes[plane_index];
    return get_plane_pitch_minimum(fcc, dim.cx, plane_index) * dim.cy * info.scale_dim_y;
}
...
constexpr int calc_minimum_img_size(uint32_t fcc, img::dim dim) noexcept
{
    ...
    {
        case img::fourcc::NV12:
            return (dim.cx * dim.cy)
                   + (dim.cx * dim.cy / 4)
                         * 2; // u and v plane are sub-sampled 2x2, interleaved in 1 planes
        case img::fourcc::YV12:
            return (dim.cx * dim.cy)
                   + (dim.cx * dim.cy / 4) * 2; // u and v plane are sub-sampled 2x2
        default:
