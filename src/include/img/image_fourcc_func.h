...
constexpr bool is_fcc_in_fcclist(img::fourcc type,
                                 std::initializer_list<img::fourcc> typelist) noexcept;
...
constexpr int get_bits_per_pixel(fourcc fcc) noexcept
{
    switch (fcc)
    {
        ...
        case fourcc::PWL_RG12_MIPI:
            return 12;
        case fourcc::PWL_RG12:
            return 16;
        case fourcc::PWL_RG16H12:
            return 16;
    }
...
{
    return fcc == img::fourcc::PWL_RG12_MIPI || fcc == img::fourcc::PWL_RG12
           || fcc == img::fourcc::PWL_RG16H12;
}

constexpr bool is_bayer_fcc(img::fourcc fcc) noexcept
{
    return is_by8_fcc(fcc) || is_by16_fcc(fcc) || is_by10_packed_fcc(fcc) || is_by12_packed_fcc(fcc)
           || is_by12_fcc(fcc) || is_by10_fcc(fcc) || is_byfloat_fcc(fcc);
}

constexpr bool is_bottom_up_fcc(img::fourcc fcc) noexcept
{
    return fcc == img::fourcc::BGR24 || fcc == img::fourcc::BGRA32 || fcc == img::fourcc::BGRA64;
}
constexpr bool is_known_fcc(img::fourcc fcc) noexcept
{
