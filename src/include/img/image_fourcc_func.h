...
//#pragma GCC diagnostic ignored "-Wswitch"
    ...
    constexpr bool		is_yuv_format( uint32_t fcc ) noexcept
    {
        ...
        {
        case img::fourcc::YUY2:		return true;
        case img::fourcc::UYVY:		return true;
        case img::fourcc::YUV8PLANAR:	return true;
        case img::fourcc::IYU1:       return true;
        case img::fourcc::IYU2:       return true;
        case img::fourcc::YUV16PLANAR:    return true;
        case img::fourcc::YUVF32PLANAR:   return true;
        default:
            return false;
        }
    }
