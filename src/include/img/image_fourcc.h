...
#define FOURCC_BGGR16_L12		mmioFOURCC('B', 'G', '1', 't')		// Bayer, 16-bit, [0;0x0FFF], little endian, BG pattern
#define FOURCC_GBRG16_L12		mmioFOURCC('G', 'B', '1', 't')		// Bayer, 16-bit, [0;0x0FFF], little endian, GB pattern
#define FOURCC_GRBG16_L12		mmioFOURCC('B', 'A', '1', 't')		// Bayer, 16-bit, [0;0x0FFF], little endian, GR pattern
#define FOURCC_RGGB16_L12		mmioFOURCC('R', 'G', '1', 't')		// Bayer, 16-bit, [0;0x0FFF], little endian, RG pattern
...
// Mono packed formats:
#define FOURCC_MONO10_PACKED		    mmioFOURCC('Y', '1', '0', 'p') // Mono, 10-bit, layout ^= FOURCC_GRBG10_PACKED
#define FOURCC_MONO10_MIPI_PACKED		mmioFOURCC('Y', '1', '0', 'P') // Mono, 10-bit, layout ^= FOURCC_GRBG10_MIPI_PACKED
...
// PWL formats:
#define FOURCC_PWL_MONO12_MIPI							mmioFOURCC('P', 'W', 'L', '0')  // PWL format, Mono 12-bit, MIPI-packed
