...
constexpr bool is_fcc_in_fcclist(const img::img_type& type,
                                 std::initializer_list<fourcc> typelist) noexcept;
constexpr bool is_fcc_in_fcclist(const img::img_descriptor& type,
                                 std::initializer_list<fourcc> typelist) noexcept;
