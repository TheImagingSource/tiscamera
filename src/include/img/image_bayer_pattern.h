...
inline constexpr by_pattern next_pixel(by_pattern pattern) noexcept
{
    switch (pattern)
    {
        ...
        case by_pattern::GR:
            return by_pattern::RG;
        case by_pattern::RG:
            return by_pattern::GR;
    };
    return by_pattern::BG;
}
...
constexpr img::fourcc img::by_transform::convert_pwl_to_fcc32f(img::fourcc val) noexcept
{
    switch (val)
    {
        case img::fourcc::PWL_RG12_MIPI:
            return img::fourcc::RGGBFloat;
        case img::fourcc::PWL_RG12:
            return img::fourcc::RGGBFloat;
        case img::fourcc::PWL_RG16H12:
            return img::fourcc::RGGBFloat;
        default:
...
constexpr img::fourcc img::by_transform::convert_fcc32f_to_fcc8(img::fourcc val) noexcept
{
    switch (val)
    {
        case img::fourcc::RAWFloat:
            return img::fourcc::RAW8;
...
constexpr img::fourcc img::by_transform::convert_bayer_fcc_to_bayer16_fcc(
    img::fourcc byfcc) noexcept
{
    return convert_pattern_to_bayer16_fcc(convert_bayer_fcc_to_pattern(byfcc));
}

constexpr img::by_transform::by_pattern img::by_transform::convert_bayer_fcc_to_pattern(
    img::fourcc fcc) noexcept
{
    switch (fcc)
    {
            // is_by8_fcc
