...
namespace
{
    ...
    const tcam_category_table_entry category_table [] =
    {
        ...
        {"Color", "BalanceWhiteMode", "BalanceRatioRaw"},
        {"Color", "BalanceWhiteMode", "BalanceWhiteAutoPreset"},
        ...
        {"Lens", "IRCutFilterEnable", "IRCutFilterEnable"},
        {"Lens", "IRCutFilterEnable", "IRCutFilterElementEnable"}, // legacy entry
        {"Image", "Gamma", "Gamma"},
        ...
        {"PartialScan", "Binning", "Binning"},
        {"PartialScan", "Binning", "BinningHorizontal"},
        {"PartialScan", "Binning", "BinningVertical"},
        {"PartialScan", "Binning", "Skippign"},
