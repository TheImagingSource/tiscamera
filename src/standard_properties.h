...
static const control_reference INVALID_STD_PROPERTY
{
    ...
    .group = { TCAM_PROPERTY_CATEGORY_UNKNOWN, TCAM_PROPERTY_INVALID, 0},
};
...
static const std::vector<struct control_reference> ctrl_reference_table =
{
    ...
    },
    {
        ...
        .group = { TCAM_PROPERTY_CATEGORY_EXPOSURE, TCAM_PROPERTY_EXPOSURE, 0 },
    },
    {
    ...
    },
    {
        ...
        .name = "Gain",
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_EXPOSURE, TCAM_PROPERTY_GAIN, 0 },
    },
    {
    ...
    },
    {
        ...
        .name = "Trigger Mode",
        .type_to_use = TCAM_PROPERTY_TYPE_BOOLEAN,
        .group = { TCAM_PROPERTY_CATEGORY_SPECIAL, TCAM_PROPERTY_TRIGGER_MODE, 0 },
    },
    {
    ...
    },
    {
        ...
        .name = "GPIO",
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_SPECIAL, TCAM_PROPERTY_GPIO, 0 },
    },
    {
    ...
    },
    {
        ...
        .name = "Offset X",
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_PARTIAL_SCAN, TCAM_PROPERTY_OFFSET_AUTO, 0 },
    },
    {
    ...
    },
    {
        ...
        .name = "Brightness",
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_EXPOSURE, TCAM_PROPERTY_BRIGHTNESS, 0 },
    },
    {
        .id = TCAM_PROPERTY_CONTRAST,
        .name = "Contrast",
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_EXPOSURE, TCAM_PROPERTY_CONTRAST, 0 },
    },
    {
        .id = TCAM_PROPERTY_SATURATION,
        .name = "Saturation",
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_COLOR, TCAM_PROPERTY_SATURATION, 0 },
    },
    {
        .id = TCAM_PROPERTY_HUE,
        .name = "Hue",
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_COLOR, TCAM_PROPERTY_HUE, 0 },
    },
    {
        .id = TCAM_PROPERTY_GAMMA,
        .name = "Gamma",
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_IMAGE, TCAM_PROPERTY_GAMMA, 0 },
    },
    {
        .id = TCAM_PROPERTY_WB,
        .name = "Whitebalance",
        .type_to_use = TCAM_PROPERTY_TYPE_BOOLEAN,
        .group = { TCAM_PROPERTY_CATEGORY_COLOR, TCAM_PROPERTY_WB, 0 },
    },
    {
    ...
    },
    {
        ...
        .name = "IRCutFilter",
        .type_to_use = TCAM_PROPERTY_TYPE_BOOLEAN,
        .group = { TCAM_PROPERTY_CATEGORY_LENS, TCAM_PROPERTY_IRCUT, 0 },
    },
    {
        .id = TCAM_PROPERTY_IRIS,
        .name = "Iris",
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_LENS, TCAM_PROPERTY_IRIS, 0 },
    },
    {
        .id = TCAM_PROPERTY_FOCUS,
        .name = "Focus",
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_LENS, TCAM_PROPERTY_FOCUS, 0 },
    },
    {
        .id = TCAM_PROPERTY_ZOOM,
        .name = "Zoom",
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_LENS, TCAM_PROPERTY_ZOOM, 0 },
    },
    {
        .id = TCAM_PROPERTY_FOCUS_AUTO,
        .name = "Focus Auto",
        .type_to_use = TCAM_PROPERTY_TYPE_BOOLEAN,
        .group = { TCAM_PROPERTY_CATEGORY_LENS, TCAM_PROPERTY_FOCUS_AUTO, 0 },
    },
    {
    ...
    },
    {
        ...
        .name = "Strobe Enable",
        .type_to_use = TCAM_PROPERTY_TYPE_BOOLEAN,
        .group = { TCAM_PROPERTY_CATEGORY_SPECIAL, TCAM_PROPERTY_STROBE_ENABLE, 0 },
    },
    {
    ...
    },
    {
        ...
        .type_to_use = TCAM_PROPERTY_TYPE_BOOLEAN,
        .group = { TCAM_PROPERTY_CATEGORY_SPECIAL, TCAM_PROPERTY_AUTO_FUNCTIONS_ROI_CONTROL, 0 },
    },
    {
    ...
    },
    {
        ...
        .name = "Shutter",
        .type_to_use = TCAM_PROPERTY_TYPE_BOOLEAN,
        .group = { TCAM_PROPERTY_CATEGORY_EXPOSURE, TCAM_PROPERTY_SHUTTER, 0 },
    },
    {
        TCAM_PROPERTY_HDR,
        .name = "HDR",
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_EXPOSURE, TCAM_PROPERTY_HDR, 0 },
    },
    {
        TCAM_PROPERTY_OIS_MODE,
        .name = "OIS Mode",
        .type_to_use = TCAM_PROPERTY_TYPE_ENUMERATION,
        .group = { TCAM_PROPERTY_CATEGORY_LENS, TCAM_PROPERTY_OIS_MODE, 0 },
    },
    {
    ...
    },
    {
        ...
        .type_to_use = TCAM_PROPERTY_TYPE_INTEGER,
        .group = { TCAM_PROPERTY_CATEGORY_PARTIAL_SCAN, TCAM_PROPERTY_OVERRIDE_SCANNING_MODE, 0 },
    },
};
