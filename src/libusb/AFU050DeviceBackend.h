...
public:
    ...
    outcome::result<void> set_int(control_definition ctrl, int64_t new_value, CONTROL_CMD cmd=SET_CUR);
    outcome::result<bool> get_bool(control_definition ctrl, CONTROL_CMD cmd=GET_CUR);
    outcome::result<void> set_bool(control_definition ctrl, bool new_value, CONTROL_CMD cmd=SET_CUR);
