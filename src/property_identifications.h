...
const TCAM_PROPERTY_ID TCAM_PROPERTY_TRIGGER_GLOBAL_RESET_RELEASE = 0x199e3024;
...
const TCAM_PROPERTY_ID TCAM_PROPERTY_STROBE_MODE = 0x199e0043;
const TCAM_PROPERTY_ID TCAM_PROPERTY_STROBE_DURATION_SECOND = 0x199e0044;
const TCAM_PROPERTY_ID TCAM_PROPERTY_STROBE_EXPOSURE_SECOND = 0x199e0045;
const TCAM_PROPERTY_ID TCAM_PROPERTY_STROBE_DELAY_SECOND = 0x199e0046;

const TCAM_PROPERTY_ID TCAM_PROPERTY_REVERSE_X = 0x199e0050;
const TCAM_PROPERTY_ID TCAM_PROPERTY_REVERSE_Y = 0x199e0051;

const TCAM_PROPERTY_ID TCAM_PROPERTY_FOCUS_ROI_TOP = 0x199e0052;
const TCAM_PROPERTY_ID TCAM_PROPERTY_FOCUS_ROI_LEFT = 0x199e0053;
const TCAM_PROPERTY_ID TCAM_PROPERTY_FOCUS_ROI_WIDTH = 0x199e0054;
const TCAM_PROPERTY_ID TCAM_PROPERTY_FOCUS_ROI_HEIGHT = 0x199e0055;
...
const TCAM_PROPERTY_ID TCAM_PROPERTY_SHUTTER = 0x199e0102;
const TCAM_PROPERTY_ID TCAM_PROPERTY_HDR = 0x199e0103;
const TCAM_PROPERTY_ID TCAM_PROPERTY_OIS_MODE = 0x199e0104;
const TCAM_PROPERTY_ID TCAM_PROPERTY_OIS_POS_X = 0x199e0105;
const TCAM_PROPERTY_ID TCAM_PROPERTY_OIS_POS_Y = 0x199e0106;
...
const TCAM_PROPERTY_ID TCAM_PROPERTY_TONEMAPPING_GLOBAL_BRIGHTNESS = 0x199e2020;
const TCAM_PROPERTY_ID TCAM_PROPERTY_TONEMAPPING_LUM_AVERAGE = 0x199e2021;
const TCAM_PROPERTY_ID TCAM_PROPERTY_TONEMAPPING_MUL_FACTOR = 0x199e2022;
const TCAM_PROPERTY_ID TCAM_PROPERTY_TONEMAPPING_ADD_FACTOR = 0x199e2023;
const TCAM_PROPERTY_ID TCAM_PROPERTY_TONEMAPPING_POW_FACTOR = 0x199e2024;

const TCAM_PROPERTY_ID TCAM_PROPERTY_IMX_LOW_LATENCY_MODE = 0x199e0262;
...
const TCAM_PROPERTY_ID TCAM_PROPERTY_OVERRIDE_SCANNING_MODE = 0x199e0353;

const TCAM_PROPERTY_ID TCAM_PROPERTY_SHARPNESS = 0x199e0340;
const TCAM_PROPERTY_ID TCAM_PROPERTY_DENOISE = 0x199e0341;
...
const TCAM_PROPERTY_ID TCAM_PROPERTY_EXPOSURE_US = 0x199e9912;
const TCAM_PROPERTY_ID TCAM_PROPERTY_POLARIZATION_VISUALIZATION = 0x199e9913;
