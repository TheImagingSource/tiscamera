                                     ...
                                     GValue* group)
{
    ...
    {
        ret = iface->get_tcam_property(
            self, name, value, min, max, def, step, type, flags, category, group);
    }
                                   ...
                                   char** connection_type)
{
    ...
    {
        ret = iface->get_tcam_device_info(self, serial, name, identifier, connection_type);
    }
