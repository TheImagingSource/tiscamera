...
public:
    ...
    : prop_name_{ d.prop_name }, prop_category_{ d.prop_category }, prop_group_{ d.prop_group }, prop_type_{ d.type }, get_flags_func_( flags_func ), static_type_flags_{ d.type_flags }
    {
    }
...
public:
    property_real(const property_desc& d,
        ...
        : property_list_funcbased_property_base { d, flags_func }, range_{ range }, set_value{ s }, get_value { g }
    {
...
struct property_integer : property_list_funcbased_property_base
{
    ...
    property_integer(const property_desc& d,
                     ...
                     get_flags_func flags_func)
        : property_list_funcbased_property_base { d, flags_func }, range_{ range }, set_value { s },
          get_value { g }
    {
...
struct property_boolean : property_list_funcbased_property_base
{
    ...
    property_boolean(const property_desc& d,
                     ...
                     bool def,
                     get_flags_func flags_func)
        : property_list_funcbased_property_base { d, flags_func },
          set_value { s }, get_value { g }, default_value_( def )
    {
...
struct property_menu : property_list_funcbased_property_base
{
    ...
    property_menu(const property_desc& d,
                  ...
                  get_value_func<int> g,
                  int def,
                  get_flags_func flags_func, const std::vector<std::string>& menu_entries )
        : property_list_funcbased_property_base { d, flags_func },
        set_value { s }, get_value { g }, menu_entries_{ menu_entries }, default_entry_index_( def )
    {
...
{
    props_.push_back( std::make_unique<property_real>( nfo, range, std::move( set ), std::move( get ), [def_flags]{ return def_flags; } ) );
}
...
{
    register_integer( nfo, range, std::move( set ), std::move( get ), std::move( [def_flags]{ return def_flags; } ) );
}
...
void tcamprop_system::property_list_funcbased::register_menu(const property_desc& dsc,
                                                         set_value_func<int> set,
                                                         get_value_func<int> get,
                                                         int def, const std::vector<std::string>& menu_entries )
{
...
{
    props_.push_back( std::make_unique<property_menu>( nfo, menu_entries, default_menu_entry, std::move( set ), std::move( get ), [def_flags]{ return def_flags; } ) );
}
...
void property_list_funcbased::register_menu( const property_desc& dsc, set_value_func<int> set, get_value_func<int> get, int def )
{
