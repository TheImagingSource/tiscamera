...
#define GST_TCAMAUTOEXPOSURE(obj) \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), GST_TYPE_TCAMAUTOEXPOSURE, GstTcamautoexposure))
#define GST_TCAMAUTOEXPOSURE_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_TCAMAUTOEXPOSURE, GstTcamautoexposureClass))
#define GST_IS_TCAMAUTOEXPOSURE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GST_TYPE_TCAMAUTOEXPOSURE))
#define GST_IS_TCAMAUTOEXPOSURE_CLASS(obj) \
    (G_TYPE_CHECK_CLASS_TYPE((klass), GST_TYPE_TCAMAUTOEXPOSURE))
