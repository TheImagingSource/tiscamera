...
// #define GST_TCAMWHITEBALANCE_CLASS(klass)   (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_TCAMWHITEBALANCE,GstTcamWhiteBalanceClass))
// #define GST_IS_TCAMWHITEBALANCE(obj)   (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_TCAMWHITEBALANCE))
// #define GST_IS_TCAMWHITEBALANCE_CLASS(obj)   (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_TCAMWHITEBALANCE))


// typedef struct
// {
//     GstBaseTransform base_tcamwhitebalance;
...
// typedef struct
// {
//     GstBaseTransformClass base_tcamwhitebalance_class;
// } GstTcamWhiteBalanceClass;
