...
{
    TcamProp*    to_TcamProp( GstElement* elem ) noexcept;
    ...
    template<typename T>
    auto  get_range( TcamProp* elem, const char* name ) -> std::optional<T> = delete;

    template<>
    auto  get_range<prop_range_integer>( TcamProp* elem, const char* name ) -> std::optional<prop_range_integer>;
    template<>
    auto  get_range<prop_range_real>( TcamProp* elem, const char* name ) -> std::optional<prop_range_real>;

    template<typename T>
    auto  get_value( TcamProp* elem, const char* name ) -> std::optional<T> = delete;
    template<>
    auto  get_value<bool>( TcamProp* elem, const char* name ) -> std::optional<bool>;
    template<>
    auto  get_value<double>( TcamProp* elem, const char* name ) -> std::optional<double>;
    template<>
    auto  get_value<int>( TcamProp* elem, const char* name ) -> std::optional<int>;
