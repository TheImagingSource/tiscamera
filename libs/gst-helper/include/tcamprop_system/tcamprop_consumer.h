...
namespace tcamprop_system
{
    ...
    template<>              auto get_range<prop_range_integer>( _TcamProp* elem, const char* name )->std::optional<prop_range_integer>;
    template<>              auto get_range<prop_range_real>( _TcamProp* elem, const char* name )->std::optional<prop_range_real>;
    ...
    template<> auto get_value<int64_t>( _TcamProp* elem, const char* name )->std::optional<int64_t>;

    bool set_value( _TcamProp* elem, const char* name, const _GValue* value_to_set );
    bool set_value( _TcamProp* elem, const char* name, bool value_to_set );
    bool set_value( _TcamProp* elem, const char* name, int value_to_set );
    bool set_value( _TcamProp* elem, const char* name, int64_t value_to_set );
    bool set_value( _TcamProp* elem, const char* name, double value_to_set );
