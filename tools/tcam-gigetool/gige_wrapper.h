...
static const unsigned int SUCCESS = 0x0;
static const unsigned int FAILURE = 0x8000;
static const unsigned int NO_DEVICE = 0x8001;
static const unsigned int INVALID_PARAMETER = 0x8002;
