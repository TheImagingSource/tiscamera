...
class TcamView(QWidget):
    ...
    def play(self, video_format=None):
        ...
        if self.state and self.settings.apply_property_cache:
            ...
            self.src.set_property("state", str(self.state))
            self.state = None
        else:
    ...
    def create_pipeline(self, video_format=None):
        ...
        self.src = self.pipeline.get_by_name("bin")

        if video_format:
            self.src.set_property("device-caps", video_format)
    ...
    def is_trigger_mode_on(self):
        ...
        try:
            (result, value,
             ...
             valuetype,
             flags,
             category, group) = self.src.get_tcam_property("Trigger Mode")
        except TypeError:
    ...
    def get_state(self):
        ...
        return self.src.get_property("state")
