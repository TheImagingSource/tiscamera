...
- Support for 39U cameras
- Support for 32U cameras
- Support for v4l2 properties AutoFocusROIWidth and Height

### Changed

- CLI11 version updated
- libgio lookup got simplified

### Fixed

- logging: Internal logger no longer overwrites user logger
- doc: Directory containing USB-2.0 camera firmware for firmware updates now points to correct dir.
- multiple compile error caused by newer compilers
- gst: Stream crash on older systems when using image/jpeg
- multiple issues concerning AFU420 properties
- tcam-capture slider segfault
